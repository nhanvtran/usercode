...
// user include files
#include "ElectroWeakAnalysis/VPlusJets/interface/simplePATAnalysis.h" 
...
ewk::simplePATAnalysis::simplePATAnalysis(const edm::ParameterSet& iConfig)
...
ewk::simplePATAnalysis::~simplePATAnalysis() {}


void ewk::simplePATAnalysis::beginJob() {
...
void ewk::simplePATAnalysis::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
    ...
    {
        //const reco::BasicJet & fat_jet = c_jets->at(j);
        std::cout << "jets_AK5PF >> number of ak5 jet daughters: " << jetIter->numberOfDaughters() << std::endl;
        //for (unsigned int i = 0; i < jetIter->numberOfDaughters(); i++){
        //    
        //    std::cout << "pt dau " << i << ": " << jetIter->daughter(i)->pt() << std::endl;
        // }
        //std::cout << "is PFJet: " << jetIter
    }
...
void ewk::simplePATAnalysis::declareTreeBranches() {
...
void ewk::simplePATAnalysis::endJob()
{
    /*
...
using ewk::simplePATAnalysis;
DEFINE_FWK_MODULE(simplePATAnalysis);
