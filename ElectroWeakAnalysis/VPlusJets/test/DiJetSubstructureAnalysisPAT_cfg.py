...
##-------- Save V+jets trees --------
process.DiJetSubstructure = cms.EDAnalyzer("DiJetSubstructureAnalysis",   
                                              HistOutFile = cms.string( OutputFileName ),

                                              PatJetCollections = cms.vstring('goodPatJetsPFlow','goodPatJetsCA8PrunedPF','goodPatJetsCA8PF','goodPatJetsCA12MassDropFilteredPF','goodPatJetsCATopTagPF','goodPatJetsCA12FilteredPF'),    
...
process.p = cms.Path( process.DiJetSubstructure )
