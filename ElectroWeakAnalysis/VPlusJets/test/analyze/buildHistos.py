...
def buildHistos(dirname,oname,isData,scaleFactors):
    ...
    for x in range(len(jtypes)):
        ...
        h_area.append( ROOT.TH1F("h_"+jtypes[x]+"_area",";jet area; count",100,0.,5.) )
        ...
        hrat_mass_ovAK5.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_mass_ovAK5",";jet mass; count",100,0.,5. ))
        hrat_mass_ovAK5g.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_mass_ovAK5g",";jet mass; count",100,0.,5. ))
        hrat_mass_ovAK7.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_mass_ovAK7",";jet mass; count",100,0.,5. ))
        hrat_mass_ovAK7g.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_mass_ovAK7g",";jet mass; count",100,0.,5. ))
        hrat_mass_ovAK8.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_mass_ovAK8",";jet mass; count",100,0.,5. ))
        hrat_mass_ovAK8g.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_mass_ovAK8g",";jet mass; count",100,0.,5. ))
        hrat_mass_ovCA8.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_mass_ovCA8",";jet mass; count",100,0.,5. ))
        hrat_mass_ovCA8g.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_mass_ovCA8g",";jet mass; count",100,0.,5. ))
        # 1D case of mass ratios
        hrat_pt_ovAK5.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_pt_ovAK5",";jet mass; count",100,0.,5. ))
        hrat_pt_ovAK5g.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_pt_ovAK5g",";jet mass; count",100,0.,5. ))
        hrat_pt_ovAK7.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_pt_ovAK7",";jet mass; count",100,0.,5. ))
        hrat_pt_ovAK7g.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_pt_ovAK7g",";jet mass; count",100,0.,5. ))
        hrat_pt_ovAK8.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_pt_ovAK8",";jet mass; count",100,0.,5. ))
        hrat_pt_ovAK8g.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_pt_ovAK8g",";jet mass; count",100,0.,5. ))
        hrat_pt_ovCA8.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_pt_ovCA8",";jet mass; count",100,0.,5. ))
        hrat_pt_ovCA8g.append( ROOT.TH1F( "hrat_"+jtypes[x]+"_pt_ovCA8g",";jet mass; count",100,0.,5. ))
        # TProfile because they are non-gaussian distributions
        prPt_mass_ovAK5.append( ROOT.TProfile("prPt_mass"+jtypes[x]+"_ovAK5","; pT; ratio of masses",npr_ptBins,pr_ptBins,0.,5.) )
        prPt_mass_ovAK5g.append( ROOT.TProfile("prPt_mass"+jtypes[x]+"_ovAK5g","; pT; ratio of masses",npr_ptBins,pr_ptBins,0.,5.) )        
        prPt_mass_ovAK7.append( ROOT.TProfile("prPt_mass"+jtypes[x]+"_ovAK7","; pT; ratio of masses",npr_ptBins,pr_ptBins,0.,5.) )
        prPt_mass_ovAK7g.append( ROOT.TProfile("prPt_mass"+jtypes[x]+"_ovAK7g","; pT; ratio of masses",npr_ptBins,pr_ptBins,0.,5.) )
        prPt_mass_ovAK8.append( ROOT.TProfile("prPt_mass"+jtypes[x]+"_ovAK8","; pT; ratio of masses",npr_ptBins,pr_ptBins,0.,5.) )
        prPt_mass_ovAK8g.append( ROOT.TProfile("prPt_mass"+jtypes[x]+"_ovAK8g","; pT; ratio of masses",npr_ptBins,pr_ptBins,0.,5.) )
        prPt_mass_ovCA8.append( ROOT.TProfile("prPt_mass"+jtypes[x]+"_ovCA8","; pT; ratio of masses",npr_ptBins,pr_ptBins,0.,5.) )
        prPt_mass_ovCA8g.append( ROOT.TProfile("prPt_mass"+jtypes[x]+"_ovCA8g","; pT; ratio of masses",npr_ptBins,pr_ptBins,0.,5.) )
        # TH2F in fit slices
        prPt_pt_ovAK5.append( ROOT.TH2F("prPt_pt"+jtypes[x]+"_ovAK5","; pT; ratio of masses",npr_ptBins,pr_ptBins,100,0.,5.) )
        prPt_pt_ovAK5g.append( ROOT.TH2F("prPt_pt"+jtypes[x]+"_ovAK5g","; pT; ratio of masses",npr_ptBins,pr_ptBins,100,0.,5.) )        
        prPt_pt_ovAK7.append( ROOT.TH2F("prPt_pt"+jtypes[x]+"_ovAK7","; pT; ratio of masses",npr_ptBins,pr_ptBins,100,0.,5.) )
        prPt_pt_ovAK7g.append( ROOT.TH2F("prPt_pt"+jtypes[x]+"_ovAK7g","; pT; ratio of masses",npr_ptBins,pr_ptBins,100,0.,5.) )
        prPt_pt_ovAK8.append( ROOT.TH2F("prPt_pt"+jtypes[x]+"_ovAK8","; pT; ratio of masses",npr_ptBins,pr_ptBins,100,0.,5.) )
        prPt_pt_ovAK8g.append( ROOT.TH2F("prPt_pt"+jtypes[x]+"_ovAK8g","; pT; ratio of masses",npr_ptBins,pr_ptBins,100,0.,5.) )
        prPt_pt_ovCA8.append( ROOT.TH2F("prPt_pt"+jtypes[x]+"_ovCA8","; pT; ratio of masses",npr_ptBins,pr_ptBins,100,0.,5.) )
        prPt_pt_ovCA8g.append( ROOT.TH2F("prPt_pt"+jtypes[x]+"_ovCA8g","; pT; ratio of masses",npr_ptBins,pr_ptBins,100,0.,5.) )
        ...
        for y in range(len(jtypes)):
            hrat_mass_1d.append( ROOT.TH1F("hrat_mass_"+jtypes[x]+"_over_"+jtypes[y],";jet mass; count",100,0.,5.) )
    ...
    for nfiles in xrange(len(dirname)):
        ...
        for i in xrange(entries):
            ...
            if chain.e_met > 35 and chain.l_pt > 35:
                           
                h_v_pt.Fill( chain.v_pt )
                h_v_mt.Fill( chain.v_mt )
                h_e_met.Fill( chain.e_met )
                ...
                for jitr in range(5):    
                    ...
                    """
                    for ptitr in range(len(pt_binLo)):
                    if ( cur_jpt > pt_binLo[ptitr] ) and ( cur_jpt < pt_binHi[ptitr] ): 
                    h_mass[jitr][ptitr].Fill( cur_jm )
                    """
                    """
                    for j2itr in range(len(jtypes)):
                    cur_j2m = chain.GetLeaf("j_"+jtypes[j2itr]+"_mass").GetValue()
                    cur_j2pt = chain.GetLeaf("j_"+jtypes[j2itr]+"_pt").GetValue()
                    hrat_mass[jitr][j2itr].Fill( cur_jm/cur_j2m )
                    prat_mass_vPt[jitr][j2itr].Fill( cur_jpt, cur_j2m/cur_jm )
                    prat_pt_vPt[jitr][j2itr].Fill( cur_jpt, cur_j2pt/cur_jpt )
                    """

                           
    #################################################
    # Put into directories different channels
    print "Writing out the histograms into ", oname
    fo.cd()
    h_v_pt.Write()
    h_v_mt.Write()
    h_e_met.Write()                            
    for x in range(len(jtypes)):
        ...
        """
        for y in range(len(pt_binLo)): h_mass[x][y].Write()
        for y in range(len(jtypes)): 
            hrat_mass[x][y].Write()
            prat_mass_vPt[x][y].Write()
            prat_pt_vPt[x][y].Write()
        """
    fo.Close()
