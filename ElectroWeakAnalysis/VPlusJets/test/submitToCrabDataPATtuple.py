...
##               # Single Electrons done so far
              ...
              "/SingleElectron/dlopes-ttbsm_v10beta_Run2011A_Aug05-2900f36c5423fd804f580f1efac6dc75/USER",
              "/SingleElectron/dlopes-ttbsm_v10beta_Run2011A_PromptV6-2900f36c5423fd804f580f1efac6dc75/USER",
              "/SingleElectron/dlopes-ttbsm_v10beta_Run2011B_PromptV1-2900f36c5423fd804f580f1efac6dc75/USER",
...
##               # Single Mu
              "/SingleMu/ntran-ttbsm_v10_SingleMu_Run2011A-May10ReReco-v1-2900f36c5423fd804f580f1efac6dc75/USER", ## this is actually V4
...
##               # Single Electrons done so far
              ...
              "dat_ch_SingleEl_2011A_Aug05",
              "dat_ch_SingleEl_2011A_promptV6",
              "dat_ch_SingleEl_2011B_promptV1",              
##               # Single Mu
...
def changeCrabTemplateFile(index):
    ...
    for line in fin.readlines():
        ...
        if  line.find("LOCATION")!=-1:
            line=line.replace("LOCATION", outputLocationOnEos)           
