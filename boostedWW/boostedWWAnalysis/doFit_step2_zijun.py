...
#            print BDTval;
    ...
    if in_model_name == "Voig":
        ...
        rrv_width_voig=ROOT.RooRealVar("rrv_width_voig"+label,"rrv_width_voig"+label,5.,1,10);
        rrv_sigma_voig=ROOT.RooRealVar("rrv_sigma_voig"+label,"rrv_sigma_voig"+label,7,1,15);
    ...
    if in_model_name == "ErfExp" :
        ...
        rrv_number = ROOT.RooRealVar("rrv_number"+label,"rrv_number"+label,1200,1,100000);
    ...
    #rrv_mass.setRange("total",30,200);
    ...
    #parameters_list[-1].setVal(parameters_list[-1].getVal()*igx_signal.getVal()/igx_total.getVal());
    #print "%s: %s"%(parameters_list[-1].GetName, parameters_list[-1].getVal());
