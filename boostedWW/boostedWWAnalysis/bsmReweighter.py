...
def lineshapeWidthReweight(point, meanSM, gammaSM, Cprime, massmin, massmax):
    ...
    rrv_mH1 = ROOT.RooRealVar("rrv_mH1","rrv_mH1", meanSM )
    rrv_gamma1 = ROOT.RooRealVar("rrv_gamma1","rrv_gamma1", gammaSM )
    
    rrv_mH2 = ROOT.RooRealVar("rrv_mH2","rrv_mH2", meanSM )
    rrv_gamma2 = ROOT.RooRealVar("rrv_gamma2","rrv_gamma2", gammaSM*Cprime)

    model1_pdf = ROOT.RooRelBWRunningWidth("model1_pdf","model1_pdf",rrv_mass,rrv_mH1,rrv_gamma1);
    model2_pdf = ROOT.RooRelBWRunningWidth("model2_pdf","model2_pdf",rrv_mass,rrv_mH2,rrv_gamma2);

    rrv_mass.setVal(point);
