...
void plotPdf_5D_VZZ() {
    ...
    TFile* fin = new TFile("AVZZ_250_JHU.root");
    ...
    */
    ...
    TFile* fin2 = new TFile("VZZ_250_JHU.root");
    ...
    box3->AddEntry(dum0,"X#rightarrow ZZ JP = 1+","lp");
    box3->AddEntry(dum1,"X#rightarrow ZZ JP = 1-","lp");
    ...
    czz->SaveAs("epsfiles/angles_VZZ250_JHU.eps");
    czz->SaveAs("pngfiles/angles_VZZ250_JHU.png");
