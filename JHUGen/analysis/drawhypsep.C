...
void drawsingle(int test, int var, int toy) 
{
  ...
  TString fileName = Form("stat_%s_%s_%s.root", testName.Data(), toyName.Data(), varName.Data() );
  ...
  if ( test & zeroplusVSzerominus ) {
    leg->AddEntry(S_H0, "Hyp1: 0+ Data", "lp");
    leg->AddEntry(S_H1, "Hyp2: 0- Data", "lp");
  }
  if ( test & zeroplusVStwoplus ) {
    leg->AddEntry(S_H0, "Hyp1: 0+ Data", "lp");
    leg->AddEntry(S_H1, "Hyp2: 2+ Data", "lp");
  }
