...
logical, public :: unweighted,OffShellHiggs,OffShellZs,OffShellZ1,OffShellZ2
...
real(8), public, parameter :: m_Grav  = 125d0      /100d0  !  X  mass (spin 0, spin 1, spin 2)
real(8), public, parameter :: Ga_Z    = 2.4952d0    /100d0  ! Z boson width(PDG-2008)! NOT USED; Z's are on-shell
real(8), public, parameter :: Ga_Grav = 0.1d0        /100d0  ! Graviton width (not used directly)
...
real(8), public, parameter :: LHC_Energy=7000d0    /100d0  ! LHC hadronic center of mass energy (LHC-expected)
