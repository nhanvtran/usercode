...
int main(int argc, char* argv[]) 
{
    ...
    _outTree->Branch("RawFatH"               ,  &RawFatH                    ,  "RawFatHiggsFlag/I:prunedmass/F:trimmedmass/F:filteredmass/F:ungroomedmass/F:pT_pr/F:eta_pr/F:px_pr/F:py_pr/F:pz_pr/F:e_pr/F:tau1/F:tau2/F:tau3/F:tau4/F:sj1_px/F:sj1_py/F:sj1_pz/F:sj1_e/F:sj2_px/F:sj2_py/F:sj2_pz/F:sj2_e/F");    
    ...
    for(unsigned int iFile=0; iFile<inputFiles_.size(); ++iFile) {
        ...
        for(ev.toBegin(); !ev.atEnd() ; ++ev, ++ievt)
            ...
            if(vhCand.FatH.FatHiggsFlag){ 
                ...
                // ******************************
                // added by Nhan
            if(vhCand.RawFatH.RawFatHiggsFlag) RawFatH.RawFatHiggsFlag =1; else FatH.FatHiggsFlag=0;
            if(vhCand.RawFatH.RawFatHiggsFlag){ 
                
                RawFatH.prunedmass = vhCand.RawFatH.prunedJetMass; 
                RawFatH.trimmedmass = vhCand.RawFatH.trimmedJetMass; 
                RawFatH.filteredmass = vhCand.RawFatH.filteredJetMass; 
                RawFatH.ungroomedmass = vhCand.RawFatH.ungroomedJetMass;

                RawFatH.pT_pr = vhCand.RawFatH.pT_pr;
                RawFatH.eta_pr = vhCand.RawFatH.eta_pr;
                
                RawFatH.px_pr = vhCand.RawFatH.px_pr;
                RawFatH.py_pr = vhCand.RawFatH.py_pr;
                RawFatH.pz_pr = vhCand.RawFatH.pz_pr;
                RawFatH.e_pr = vhCand.RawFatH.e_pr;
                
                RawFatH.tau1 = vhCand.RawFatH.tau1;
                RawFatH.tau2 = vhCand.RawFatH.tau2;
                RawFatH.tau3 = vhCand.RawFatH.tau3;
                RawFatH.tau4 = vhCand.RawFatH.tau4;
                
                RawFatH.sj1_px_pr = vhCand.RawFatH.sj1_px_pr;
                RawFatH.sj1_py_pr = vhCand.RawFatH.sj1_py_pr;
                RawFatH.sj1_pz_pr = vhCand.RawFatH.sj1_pz_pr;
                RawFatH.sj1_e_pr = vhCand.RawFatH.sj1_e_pr;
                
                RawFatH.sj2_px_pr = vhCand.RawFatH.sj2_px_pr;
                RawFatH.sj2_py_pr = vhCand.RawFatH.sj2_py_pr;
                RawFatH.sj2_pz_pr = vhCand.RawFatH.sj2_pz_pr;                
                RawFatH.sj2_e_pr = vhCand.RawFatH.sj2_e_pr;                
